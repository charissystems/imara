 ...
 */
loanRoutes.post('/products', enforcePermission('loan_products', 'create'), validate(createLoanProductSchema), async (c) => {
 ...
 */
loanRoutes.patch('/products/:productId', enforcePermission('loan_products', 'update'), validate(updateLoanProductSchema), async (c) => {
    const { productId } = c.req.param();
 ...
 */
loanRoutes.patch('/applications/:applicationId/approve', enforcePermission('loan_applications', 'approve'), validate(approveLoanApplicationSchema), async (c) => {
    const { applicationId } = c.req.param();
 ...
 */
loanRoutes.patch('/applications/:applicationId/reject', enforcePermission('loan_applications', 'approve'), validate(rejectLoanApplicationSchema), async (c) => {
    const { applicationId } = c.req.param();
 ...
 */
loanRoutes.post('/applications/:applicationId/appraisal', enforcePermission('loan_applications', 'update'), validate(appraisalSchema), async (c) => {
    const { applicationId } = c.req.param();
 ...
 */
loanRoutes.post('/:loanId/disburse', enforcePermission('loans', 'update'), validate(disburseLoanSchema), async (c) => {
    const { loanId } = c.req.param();
 ...
 */
loanRoutes.post('/:loanId/reschedule', enforcePermission('loans', 'update'), validate(rescheduleLoanSchema), async (c) => {
    const { loanId } = c.req.param();
 ...
 */
loanRoutes.post('/:loanId/write-off', enforcePermission('loans', 'approve'), validate(writeOffLoanSchema), async (c) => {
    const { loanId } = c.req.param();
